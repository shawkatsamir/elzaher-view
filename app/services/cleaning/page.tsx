...
export const metadata: Metadata = {
  title: "أفضل شركة تنظيف منازل وفلل بالرياض والمملكة | خدمات تنظيف شاملة",
  description:
    "خدمات تنظيف احترافية للمنازل، الفلل، والمكاتب في الرياض وجدة وجميع مدن المملكة. تنظيف بالبخار، غسيل كنب وسجاد، تعقيم خزانات. احجز موعدك الآن مع أفضل فريق متخصص.",
  keywords: [
    "شركة تنظيف منازل",
    "تنظيف فلل الرياض",
    "شركة تنظيف بجدة",
  ...
  openGraph: {
    title: "خدمات التنظيف الاحترافية | جودة وضمان 100%",
    description:
      "نقدم خدمات تنظيف شاملة للمنازل والمكاتب والفلل بأعلى معايير الجودة والنظافة.",
    images: ["/images/services/cleaning.webp"],
  },
};
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="mb-6 text-3xl font-bold text-gray-900">
              لماذا تختارنا كأفضل شركة تنظيف بالمملكة؟
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-gray-600">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold">
              خدمات تنظيف شاملة للمنازل والمكاتب
            </h2>
