...
export default function HomePage() {
  ...
  const services = [
    ...
    {
      title: "خدمات تركيب باركية",
      description:
        "معلم تركيب باركية محترف لجميع الأنواع: خشب طبيعي، باركية مهندس، وفينيل SPC وLVT مع ضمان الجودة",
      image: "/images/services/Contracting.jpeg",
      link: "/معلم-تركيب-باركية",
      icon: <Layers className="h-6 w-6" />,
      features: [
        "تركيب باركية خشب الأرو والزان والموسكي",
        "تركيب باركية مهندس بنظام Click",
        "تركيب فينيل SPC وLVT مقاوم للماء",
        "تركيب باركية فوق التدفئة الأرضية",
        "تركيب اللباد العازل ونعلة الباركية",
      ],
    },
    {
      title: "خدمات تركيب السيراميك والبلاط",
      description:
        "معلم تركيب سيراميك وبلاط متخصص للأرضيات والحوائط والحمامات والمطابخ بأحدث تقنيات القص بالليزر",
      image: "/images/services/Contracting.jpeg",
      link: "/معلم-تركيب-سيراميك",
      icon: <Grid3x3 className="h-6 w-6" />,
      features: [
        "تركيب بلاط وسيراميك للأرضيات والحوائط",
        "تركيب بورسلين كبير المقاس 60×120 و 80×160",
        "تركيب رخام وجرانيت للقصور والفلل",
        "تركيب موزايك الحمامات وحول المسابح",
        "قص بالليزر بفواصل دقيقة 1 ملم",
      ],
    },
  ];
